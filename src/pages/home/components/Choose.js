...
export default function Choose() {
    return (
        <div style={{ marginTop: "80px" }}>
            <Container>
                <hr />
                <h3 style={{ padding: "30px 15px", marginBottom: "50px" }}>Why Choose Us</h3>
                ...
                <Row>
                    <Col xs={12} md={4}>
                        ...
                        <h4 style={{ marginTop: "-100px", marginBottom: "100px" }}>Prices you can't beat!</h4>
                    </Col>
                    <Col xs={12} md={4}>
                        <div style={{ width: "25px", margin: "auto" }}>
                            <svg>
                        ...
                        <h4 style={{ marginTop: "-100px", marginBottom: "100px" }}>
                            Booking is safe
                        </h4>
                    </Col>
                    <Col xs={12} md={4}>
                    ...
                    <Col xs={12} md={4}>
                        ...
                        <h4 style={{ marginTop: "-100px", marginBottom: "100px" }}>Great location and facilities for couples</h4>
                    </Col>
                </Row>
            </Container>
        </div>
